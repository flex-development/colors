...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/colors
   cd colors
   ```
...
```sh
https://github.com/flex-development/colors/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/colors/discussions/new?category=q-a
